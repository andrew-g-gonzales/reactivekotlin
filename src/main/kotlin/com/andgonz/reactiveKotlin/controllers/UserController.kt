...
import com.andgonz.reactiveKotlin.models.User
import com.andgonz.reactiveKotlin.repositories.UserRepository
import com.andgonz.reactiveKotlin.requests.UserCreateRequest
import com.andgonz.reactiveKotlin.responses.PagingResponse
import com.andgonz.reactiveKotlin.responses.UserCreateResponse
...
class UserController {
    ...
    suspend fun listUsers(
        ...
        val list = userRepository
            .findAllUsers(limit, offset)
            .collectList()
            .awaitFirst()
        val total = userRepository
            .count().awaitFirst()
